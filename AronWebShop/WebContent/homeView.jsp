...
<body>
	...
	<div id="wrapperMenu">
		...
		<div id="filter">
				...
				<a href="${tempLink}" style="class:'agreen'">
					<img height="45px" alt="" src="pictures/icons/all_logo.png">
				</a>
				...
				<a href="${tempLink}">
					<img height="45px" alt="" src="pictures/icons/horde_logo.png">
				</a>
				...
				<a href="${tempLink}">
					<img height="45px" alt="" src="pictures/icons/alliance_logo.png">
				</a>
					...
					<form method="post" action="AddToCartServlet">
						<table>
							<tr>
								...
								<td colspan="5" align="center"><div style="height: 250px; overflow:hidden;"><img src="${tempProduct.imagePatj}"></div></td>
							</tr>
							<tr>
								<td><label>${tempProduct.price}0$</label></td>
								<td><input type="number" name="quantity" min="1" max="20" value="1"></td>
								<td colspan="2" align="right"><button name="product" value="${tempProduct.id}" type="submit">Add to cart</button>
							</tr>
						</table>
						</form>
					</td>
