					...
					<td>
						<table>
							...
							<tr>
								...
								<td><label>Total: ${tempProduct.price*tempProduct.amount}</label></td>
							</tr>
							<tr>
								<td align="right"><button name="productAdd" value="${tempProduct.id}" type="submit">+</button></td>
								<td align="right"><button name="productReduce" value="${tempProduct.id}" type="submit">-</button></td>
								<td align="right"><button name="productRemove" value="${tempProduct.id}" type="submit">X</button></td>
							</tr>
						</table>
					</td>					
						</tr>	
